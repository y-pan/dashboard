...
export function validateConfig(): void {
  ...
  requireStringNotBlank(portItems[0].name, `portItems need to contain item like {"name": "name", "port": 12345, group: "some-optinal-group"}`);
  requireNumberPositive(portItems[0].port, `portItems need to contain item like {"name": "name", "port": 12345, group: "some-optinal-group"}`);
